...
class Game:
    ...
    def check_win(self,eval=False):
        ...
        for col in range (7):
            for row in range(5,-1,-1):
                    ...
                    if cur_token == token_counted:
                        ...
                        if token_counted == '\033[1;30;40mB':
                            ...
                            if num_in_a_row == 2:
                                ...
                                max_niar_R += 1
                    elif cur_token == last_play_token:
                        if last_play_token == '\033[1;30;40mB':
                            if num_in_a_row == 1:
                                two_niar_B += 1
                            elif num_in_a_row == 2:
                                max_niar_B += 1
                        elif last_play_token == '\033[1;31;41mR':
                            if num_in_a_row == 1:
                                two_niar_R += 1
                            elif num_in_a_row == 2:
                                max_niar_R += 1
                        ...
                        if token_counted == '\033[1;30;40mB':
                            if num_in_a_row == 2:
                                ...
                                max_niar_B -= 1
                        elif token_counted == '\033[1;31;41mR':
                            if num_in_a_row == 2:
                                two_niar_R -= 1
                            elif num_in_a_row == 3:
                                max_niar_R -= 1
                ...
                if eval:
                    if num_in_a_row == 4 and token_counted == '\033[1;31;41mR':
    ...
    def eval(self, turn):
        ...
        if over:
            ...
            score =  max_niar_B*(10**3) + two_niar_B*(10**2)
            score -= max_niar_R*(10**3) + two_niar_R*(10**2)
            if self.debug:
                print ("Eval = "+str(score))
                print ("B 3: "+str(max_niar_B)+"; R 3: "+str(max_niar_R))
                print ("B 2: "+str(two_niar_B)+"; R 2: "+str(two_niar_R))
                a = input()
            return score
